...
@section('content')
				<form class="listing-form"
					sort-url="{{ action('PRListController@sort') }}"
					data-url="{{ action('PRListController@listing') }}"
				...
				>				
					<div class="row top-list-controls">
								...
								<div class="filter-box">
									<div class="btn-group list_actions hide">
										...
										<ul class="dropdown-menu">
											<li>
												<a list-delete-confirm="{{ action('PRListController@deleteConfirm') }}" href="{{ action('PRListController@delete') }}"><i class="icon-trash"></i> {{ trans('messages.delete') }}</a>												
											</li>
										</ul>
									</div>
						...
						<div class="col-md-2 text-right">
							<a href="{{ action("PRListController@create") }}" type="button" class="btn bg-info-800">
