...
@section('content')
				...
				<form class="listing-form"
					data-url="{{ action('PRSegmentController@listing', $list->uid) }}"
					per-page="{{ Acelle\Model\PRSegment::$itemsPerPage }}"					
				>				
					<div class="row top-list-controls">
								...
								<div class="filter-box">
									<div class="btn-group list_actions hide mr-10">
										...
										<ul class="dropdown-menu">											
											<li>
												<a delete-confirm="{{ trans('messages.delete_segments_confirm') }}" href="{{ action('PRSegmentController@delete', $list->uid) }}">
						...
						<div class="col-md-2 text-right">
							<a href="{{ action("PRSegmentController@create", $list->uid) }}" type="button" class="btn bg-info-800">
