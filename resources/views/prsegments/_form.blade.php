                    <div class="sub_section">
						<div class="row">
							<div class="col-md-8">
								@include('helpers.form_control', ['type' => 'text', 'name' => 'name', 'value' => $segment->name, 'rules' => Acelle\Model\PRSegment::$rules])
							</div>
							<div class="col-md-4">
								@include('helpers.form_control', ['type' => 'select', 'name' => 'matching', 'label' => trans('messages.how_subscribers_matching'), 'value' => $segment->matching, 'help_class' => 'segment', 'options' => Acelle\Model\PRSegment::getTypeOptions(), 'rules' => Acelle\Model\PRSegment::$rules])
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								...
								<div class="segment-conditions-container">
									@foreach ($segment->segmentConditions as $condition)
										<div class="row condition-line" rel="{{ $condition->uid }}">
											...
											<div class="col-md-7 operator_value_col" data-url="{{ action('PRSegmentController@conditionValueControl') }}">
								...
								<br />
								<a sample-url="{{ action('PRSegmentController@sample_condition', $list->uid) }}" href="#add_condition" class="btn btn-info bg-teal-800 add-segment-condition">
