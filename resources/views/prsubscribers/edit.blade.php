    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-lg-6">
            <div class="sub-section">
                ...
                <form action="{{ action('PRSubscriberController@update', ['list_uid' => $list->uid, "uid" => $subscriber->uid]) }}" method="POST" class="form-validate-jqueryz">
                    {{ csrf_field() }}
            ...
            <div class="sub-section">
                ...
                @if (is_null($subscriber->emailVerification))
                    ...
                    <form enctype="multipart/form-data" action="{{ action('PRSubscriberController@startVerification', ['uid' => $subscriber->uid]) }}" method="POST" class="form-validate-jquery">
                        {{ csrf_field() }}
                ...
                @elseif ($subscriber->emailVerification->isDeliverable())
                    ...
                    <form enctype="multipart/form-data" action="{{ action('PRSubscriberController@resetVerification', ['uid' => $subscriber->uid]) }}" method="POST" class="form-validate-jquery">
                        <input type="hidden" name="list_uid" value="{{ $list->uid }}" />
